...
export class Stotram extends Component {
  render() {
    return (
      <div className="stotram">
        <pre>
          {`
    ...
    ఇతి శ్రీ మహాభారతే శతసాహస్రికాయాం సంహితాయాం వైయాసిక్యామనుశాసన 
    పర్వాంతర్గత ఆనుశాసనిక పర్వణి, మోక్షధర్మే భీష్మ యుధిష్ఠిర సంవాదే 
    శ్రీ విష్ణోర్దివ్య సహస్రనామ స్తోత్రం నామైకోన పంచ శతాధిక శతతమోధ్యాయః ‖
