...
function RamaHome() {
  return (
    <div className="w-full">
      <br />
      <div className="text-4xl text-center">Ramayanam</div>
      <br /><br />
      <div className="flex flex-col lg:flex-row">
        {/* First Column (30%) */}
        <div className="w-full lg:w-3/10 flex items-start justify-center">
          <div className="flex flex-row justify-center"> 
            <img src="https://i.etsystatic.com/60362153/r/il/1eef9d/7652276719/il_1140xN.7652276719_qa7b.jpg" alt="Rama" />
          </div>
        </div>
        ...
        <div className="w-full lg:w-7/10 flex items-center justify-center p-2">
          <div className="md:px-10 px-5">
            <div className="text-center">Please click these buttons below to view slokas (list and detailed study) of Sri Ramayanam.</div>
            <br /><br />
            <div className="flex flex-wrap justify-center gap-2 mt-2">
              <Link to="/rama/1" className="sv-btn">Bala Kanda</Link>
