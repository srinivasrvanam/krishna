...
function DAHome() {
  return (
    <div className="w-full">
      <br />
      <div className="text-4xl text-center">Sri Damodara Ashtakam </div>
      <br /><br />
      <div className="flex flex-col lg:flex-row">
        {/* First Column (30%) */}
        <div className="w-full lg:w-3/10 flex items-start justify-center">
          <div className="flex flex-row justify-center"> 
            <img src="https://www.harekrsna.de/yasoda/Damodar_s.jpg" alt="Damodara" />
          </div>
        </div>
        ...
        <div className="w-full lg:w-7/10 flex items-center justify-center p-2">
          <div className="md:px-10 px-5">
            <div className="text-center">Please click these buttons below to view slokas (list and detailed study) of Sri Damodara Ashtakam.</div>
            <br /><br />
            <div className="flex flex-wrap justify-center gap-2 mt-2">
              <Link to="/da/1" className="sv-btn">दामोदराष्टकम्</Link>
