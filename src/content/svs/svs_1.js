...
const verses = [
  ...
  },
  {
      ...
      vicheda: [
          "ब्रह्म-आदयः सुर-वराः स-महर्षयः ते",
      ...
      anvaya: [
          "अथ (तु)",
          "ते",
          "- ब्रह्म-आदयः सुर-वराः स-महर्षयः",
          "- सन्तः सनन्दन-मुखाः योगिवर्याः",
      ...
      transl: [
          "Now Indeed",
          "Those",
          "- Gods like, Brahma and others, along with Maharshis",
          "- Saints like Sanandana and the best of Yogis,",
          "- have come (आगताः) to your abode (धाम अन्तिके) with auspicious items in their hands (मङ्गल-वस्तु-हस्ताः).",
          "O Lord of Venkatachala!",
          "May it be an auspicious dawn (morning) to you.",
