const verses = [
  {
    ...
    anvaya: [
      "अर्जुनः उवाच -",
      "एवं सततयुक्ताः ये भक्ताः त्वाम् पर्युपासते, ये च अपि अक्षरम् अव्यक्तम् (पर्युपासते), तेषाम् के योगवित्तमाः (सन्ति) ?"
    ],
    transl: [
      "Arjuna said:",
      "Thus, those devotees who, being ever-steadfast, worship You (in personal form), and those who also (worship) the imperishable, unmanifested (Brahman)—of these two, who are the most proficient in Yoga?"
    ],
    essence: [
      "Arjuna inquired: Between those who are ever steadfastly engaged in your devotional service and worship you as a personal form, and those who worship the unmanifested, imperishable Brahman—who is considered to be more perfect in Yoga?"
    ],
    essence_tel: [
      "అర్జునుడు అడిగాడు: ఎల్లప్పుడూ నియమబద్ధులై నిన్నే పరమేశ్వరునిగా భావించి సాకారరూపంలో ఉపాసించే భక్తులు, మరియు అవ్యక్తమైన, అక్షరమైన పరబ్రహ్మాన్ని ఉపాసించేవారు—వీరిద్దరిలో ఎవరు శ్రేష్ఠులైన యోగ నిష్ణాతులు?"
    ],
    meanings: [
      "अर्जुनः उवाच = Arjuna said",
      "एवम् = Thus",
      "सतत-युक्ताः = Always engaged / Ever steadfast",
      "ये = Those who",
      "भक्ताः = Devotees",
      "त्वाम् = You",
      "पर्युपासते = Worship properly",
      "ये = Those who",
      "च = And",
      "अपि = Also",
      ...
      "तेषाम् = Of them",
      "के = Who",
      "योग-वित्तमाः = More proficient in Yoga"
    ],
    notes: [
      "This verse begins the 12th Chapter of the Bhagavad Gita, titled 'Bhakti Yoga' (The Yoga of Devotion).",
      "Arjuna is asking Krishna to clarify the definitive path to spiritual perfection by comparing two major philosophical approaches: Saguna Upasana (worship of God with form) and Nirguna Upasana (meditation on the formless, abstract Absolute)."
    ]
  },
  {
    chapter: 12,
    ...
    vicheda: [
      ...
      "श्रद्धया परया उपेताः ते मे युक्त-तमाः मताः ||"
    ],
    anvaya: [
      "श्रीभगवान् उवाच -",
    ...
    essence: [
      "Lord Krishna answers Arjuna's question directly: those who establish their minds firmly upon His personal form and worship Him with unwavering, supreme faith are considered the highest and most perfectly united with Him."
    ],
    essence_tel: [
      "శ్రీకృష్ణ భగవానుడు పలికాడు: ఎవరైతే తమ మనస్సులను నాపై నిలిపి, పరమ శ్రద్ధతో నన్ను నిరంతరం ఆరాధిస్తారో, వారే నా దృష్టిలో అత్యంత శ్రేష్ఠులైన యోగులు."
    ],
    meanings: [
      "श्रीभगवान् उवाच = The Supreme Lord said",
      "मयि = On Me",
      "आवेश्य = Fixing / Absorbing",
      "मनः = The mind",
      "ये = Those who",
      "माम् = Me",
      "नित्य-युक्ताः = Always steadfast / Ever united",
      "उपासते = Worship",
      "श्रद्धया = With faith",
      "परया = Supreme / Transcendental",
      "उपेताः = Endowed with",
      "ते = They",
      "मे = By Me",
      "युक्त-तमाः = Most perfect in Yoga",
      "मताः = Considered / Thought to be"
    ],
    notes: [
      "Krishna begins His response by validating Saguna Bhakti (worship of the personal form of God) as the path that leads to the most immediate and profound spiritual union.",
      "The use of the words 'Paraya' (supreme) and 'Shradhaya' (faith) highlights that emotional and spiritual investment, rather than mere intellectual analysis, is the core of true Bhakti."
    ]
  },
  {
    chapter: 12,
    ...
    meanings: [
      ...
      "तु = But",
      "अक्षरम् = The imperishable",
      "अनिर्देश्यम् = The indefinable / Indescribable",
      "अव्यक्तम् = The unmanifested",
      "पर्युपासते = Worship perfectly / Meditate upon",
      "सर्वत्र-गम् = Omnipresent / All-pervading",
      "अचिन्त्यम् = Unthinkable / Inconceivable",
      "च = And",
  ...
  },
  {
    ...
    meanings: [
      ...
      "सम-बुद्धयः = Possessing an even mind / Equanimous",
      "ते = They",
      "प्राप्नुवन्ति = Attain / Reach",
      "माम् = Me",
      "एव = Only / Indeed",
      "सर्व-भूत-हिते = In the welfare of all living beings",
      "रताः = Engaged / Rejoicing"
    ],
    notes: [
  ...
  },
  {
    ...
    sloka_tel: [
      "క్లేశోఽధికతరస్తేషామవ్యాక్తాసక్తచేతసామ్ |",
    ...
    essence_tel: [
      "రూపము లేని అవ్యక్త పరబ్రహ్మమునందు మనస్సును లగ్నం చేసినవారికి కష్టములు మరీ ఎక్కువ. ఎందుకంటే, దేహాభిమానము కలిగిన జీవులకు నిరాకార మార్గమును అవలంబించడం చాలా క్లేశకరమైనది."
    ],
    meanings: [
      "क्लेशः = Trouble / Hardship / Difficulty",
      "अधिकतरः = Much greater / More troublesome",
      "तेषाम् = Of those",
      "अव्यक्त-आसक्त-चेतसाम् = Whose minds are attached to the unmanifested",
      "अव्यक्ता = The unmanifested / Formless",
      "हि = Because / Certainly",
      "गतिः = Path / Goal",
      "दुःखम् = Through suffering / With great difficulty",
      "देह-वद्भिः = By the embodied beings (those with body-consciousness)",
      "अवाप्यते = Is attained / Achieved"
    ],
    notes: [
  ...
  },
  {
    ...
    meanings: [
      ...
      "तु = But",
      "सर्वाणि = All",
      "कर्माणि = Actions / Duties",
      "मयि = Unto Me",
      "संन्यस्य = Renouncing / Surrendering",
      "मत्पराः = Intent on Me / Regarding Me as Supreme",
      "अनन्येन = Exclusive / Undivided / Unswerving",
      "एव = Only / Certainly",
  ...
  },
  {
    ...
    meanings: [
      ...
      "मृत्यु-संसार-सागरात् = From the ocean of death-bound material existence",
      "भवामि = I become",
      "नचिरात् = Without delay / Swiftly",
      "पार्थ = O son of Pritha (Arjuna)",
      "मयि = In Me",
      "आवेशित-चेतसाम् = Of those whose minds are fully absorbed"
    ],
    notes: [
  ...
  },
  {
    ...
    essence_tel: [
      "నీ మనస్సును నాపైనే స్థిరపరచుము, నీ బుద్ధిని నాకే అప్పగించుము. ఆ పైన నీవు నాలోనే నివసిస్తావు, ఇందులో ఎలాంటి సందేహము లేదు."
    ],
    meanings: [
      "मयि = In Me",
      "एव = Alone / Certainly",
      "मनः = The mind",
      "आधत्स्व = Fix / Establish",
      "मयि = In Me",
      "बुद्धिम् = The intellect / Discriminating faculty",
      "निवेशय = Cause to enter / Rest",
      "निवसिष्यसि = You will reside / Live",
      "मयि = In Me",
      "एव = Alone",
      "अतः ऊर्ध्वम् = Hereafter / After this life",
      "न = Not",
      "संशयः = Doubt"
    ],
    notes: [
  ...
  },
  {
    ...
    essence_tel: [
      "ఓ ధనంజయా! ఒకవేళ నీవు నీ మనస్సును నాపై స్థిరంగా నిలుపలేకపోతే, అభ్యాసయోగము ద్వారా (మళ్లీ మళ్లీ మనస్సును నాపైకి మళ్లించే సాధన ద్వారా) నన్ను పొందుటకు ప్రయత్నించుము."
    ],
    meanings: [
      "अथ = If, however",
      "चित्तम् = The mind / Consciousness",
      "समाधातुम् = To fix steadily / Establish",
      "न = Not",
      "शक्नोषि = You are able",
      "मयि = On Me",
      "स्थिरम् = Unchanging / Steadfast",
      "अभ्यास-योगेन = By the yoga of constant practice",
      "ततः = Then",
      "माम् = Me",
      "इच्छ = Desire / Seek",
      "आप्तुम् = To attain / Reach",
  ...
  },
  {
    ...
    number: 10,
    sloka: [
      "अभ्यासेऽप्यसमर्थोसी मत्कर्मपरमो भव |",
    ...
    essence_tel: [
      "ఒకవేళ నీవు ఈ అభ్యాసము చేయుటకు కూడా సమర్థుడవు కాకపోతే, నా కొరకే కర్మలను చేసేవాడవు (మత్కర్మపరముడవు) అవ్వు. నా కోసమే కర్మలను ఆచరిస్తూ కూడా నీవు సిద్ధిని (ముక్తిని) పొందగలవు."
    ],
    meanings: [
      "अभ्यासे = In constant practice",
      "अपि = Even / Also",
      "असमर्थः = Incapable / Unable",
      "असि = You are",
      "मत्-कर्म-परमः = Dedicated to actions for Me / Regarding My work as supreme",
      "भव = Become",
      "मदर्थम् = For My sake",
      "अपि = Also",
      "कर्माणि = Actions / Duties",
      "कुर्वन् = Performing",
      "सिद्धिम् = Perfection / Spiritual success",
      "अवाप्स्यसि = You will attain"
    ],
    notes: [
  ...
  },
  {
    ...
    vicheda: [
      "अथ | एतद् | अपि | अशक्तः | असि | कर्तुम् | मत्-योगम् | आश्रितः |",
    ...
    essence_tel: [
      "ఒకవేళ నీవు నా కొరకే కర్మలను చేయడం కూడా చేతకాకపోతే, నన్ను శరణు వేడి, ఆత్మనిగ్రహం కలిగి, నీవు చేసే సమస్త కర్మల యొక్క ఫలితాలను ఆశించకుండా వదిలిపెట్టుము (కర్మఫల త్యాగము చేయుము)."
    ],
    meanings: [
      "अथ = If, however",
      "एतद् = This",
      "अपि = Even / Also",
      "अशक्तः = Incapable / Unable",
      "असि = You are",
      "कर्तुम् = To do",
      "मत्-योगम् = Devotion to Me / My Yoga",
      "आश्रितः = Taking shelter of / Resorting to",
      "सर्व-कर्म-फल-त्यागम् = Renunciation of the fruits of all actions",
      "ततः = Then / Therefore",
      "कुरु = Do / Practice",
      "यत-आत्म-वान् = Being self-controlled / Reining in the mind"
    ],
    notes: [
  ...
  },
  {
    ...
    essence_tel: [
      "లక్ష్యం తెలియకుండా చేసే గుడ్డి అభ్యాసం కంటే శ్రేష్ఠమైన జ్ఞానం మేలు. ఆ జ్ఞానం కంటే ధ్యానం ఉత్తమం. ధ్యానం కంటే కర్మఫలాలను త్యజించడం ఇంకా శ్రేష్ఠమైనది. ఎందుకంటే కర్మఫల త్యాగం చేసిన వెంటనే పరమ శాంతి లభిస్తుంది."
    ],
    meanings: [
      "श्रेयः = Better / Superior",
      "हि = Certainly / Indeed",
      "ज्ञानम् = Knowledge / Wisdom",
      "अभ्यासात् = Than mechanical practice",
      "ज्ञानात् = Than knowledge",
      "ध्यानम् = Meditation",
      "विशिष्यते = Is considered better / Excels",
      "ध्यानात् = Than meditation",
      "कर्म-फल-त्यागः = Renunciation of the fruits of actions",
      "त्यागात् = From such renunciation",
      "शान्तिः = Peace / Tranquility",
      "अनन्तरम् = Immediately following"
    ],
    notes: [
  ...
  },
  {
    ...
    meanings: [
      "अद्वेष्टा = Non-envious / Hating no one",
      "सर्व-भूतानाम् = Toward all living entities",
      "मैत्रः = Friendly",
      "करुणः = Compassionate",
      "एव = Certainly",
      "च = And",
  ...
  },
  {
    ...
    meanings: [
      ...
      "यत-आत्मा = Self-controlled / Restrained in mind",
      "दृढ-निश्चयः = Possessed of firm conviction / Resolution",
      "मयि = Unto Me",
      "अर्पित-मनो-बुद्धिः = Whose mind and intellect are surrendered",
      "यः = Who",
  ...
  },
  {
    ...
    essence_tel: [
      "ఎవరి వలన లోకము కలత చెందదో, లోకము వలన ఎవడు కలత చెందడో, మరియు ఎవడైతే అతిసంతోషము, అసూయ, భయము, ఆందోళనల నుండి విముక్తుడై ఉంటాడో—అతడు నాకు ప్రియమైనవాడు."
    ],
    meanings: [
      "यस्मात् = By whom",
      "न = Not",
      "उद्विजते = Is agitated / Distressed",
      "लोकः = The world / People",
      "लोकात = From the world / People",
      "न = Not",
      "उद्विजते = Is agitated",
      "च = And",
      "यः = Who",
      "हर्ष-अमर्ष-भय-उद्वेगैः = By material joy, envy, fear, and anxiety",
      "मुक्तः = Freed",
      "यः = Who",
      "सः = He",
      "च = Also",
  ...
  },
  {
    ...
    essence_tel: [
      "ఎలాంటి అపేక్ష లేనివాడు, బాహ్యాభ్యంతర శుద్ధి కలవాడు, కార్యనిపుణుడు, తటస్థుడు (పక్షపాతం లేనివాడు), బాధలు లేనివాడు, అహంకారపూరిత స్వార్థ కర్మలను వదిలిపెట్టినవాడు అయిన నా భక్తుడు నాకు ప్రియమైనవాడు."
    ],
    meanings: [
      "अनपेक्षः = Free from expectations / Desireless",
      "शुचिः = Pure (internally and externally)",
      "दक्षः = Expert / Skillful / Efficient",
      "उदासीनः = Unconcerned / Neutral / Indifferent",
      "गत-व्यथः = Free from pain / Untroubled / Without anxiety",
      "सर्व-आरम्भ-परित्यागी = Renouncer of all personal initiatives / Selfish undertakings",
      "यः = Who",
      "मत्-भक्तः = My devotee",
      "सः = He",
      "मे = To Me",
  ...
  },
  {
    ...
    essence_tel: [
      "ఎవడైతే లౌకిక లాభాలకు సంతోషపడడో, దేనినీ ద్వేషించడో, దేనికోసమూ శోచించడో, దేనినీ ఆశించడో, మరియు శుభాశుభ కర్మల ఫలితాలను త్యజించినవాడో—అలాంటి భక్తుడు నాకు అత్యంత ప్రియమైనవాడు."
    ],
    meanings: [
      "यः = Who",
      "न = Neither",
      "हृष्यति = Rejoices / Gets elated",
      "न = Nor",
      "द्वेष्टि = Hates / Resents",
      "न = Nor",
      "शोचति = Grieves / Laments",
      "न = Nor",
      "काङ्क्षति = Desires / Hankers after",
      "शुभ-अशुभ-परित्यागी = Renouncer of both good and bad fortune",
      "भक्ति-मान् = Full of devotion",
      "यः = Who",
      "सः = He",
      "मे = To Me",
      "प्रियः = Dear"
  ...
  },
  {
    ...
    meanings: [
      "समः = Equal / Equanimous",
      "शत्रौ = Toward an enemy",
      "च = And",
      "मित्रे = Toward a friend",
      "च = And",
      "तथा = As well as",
  ...
  },
  {
    ...
    meanings: [
      ...
      "संतुष्टः = Contented",
      "येन केनचित् = With anything / Whatever comes by chance",
      "अनिकेतः = Without a fixed home / Free from domestic attachment",
      "स्थिर-मतिः = Of steady mind / Firm intellect",
      "भक्ति-मान् = Full of devotion",
      "मे = To Me",
      "प्रियः = Dear",
  ...
  },
  {
    ...
    essence_tel: [
      "కాని, ఎవరైతే పరమ శ్రద్ధ కలిగి, నన్నే పరమగమ్యముగా భావించి, పైన చెప్పబడిన ఈ ధర్మామృతాన్ని యథావిధిగా అనుసరిస్తారో—అలాంటి భక్తులు నాకు అన్నిటికంటే మిక్కిలి ప్రియమైనవారు."
    ],
    meanings: [
      "ये = Those who",
      "तु = But / Indeed",
      "धर्म्य-अमृतम् = Nectar of righteousness / Dharma",
      "इदम् = This",
      "यथा = As",
      "उक्तम् = Spoken / Described",
      "पर्युपासते = Follow faithfully / Cultivate properly",
      "श्रद्दधानाः = Endowed with faith",
      "मत्-परमाः = Taking Me as the supreme goal",
      "भक्ताः = Devotees",
      "ते = They",
      "अतीव = Exceedingly / Beyond measure",
      "मे = To Me",
      "प्रियाः = Dear"
    ],
    notes: [
