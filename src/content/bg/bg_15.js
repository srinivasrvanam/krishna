const verses = [
  ...
  },
  {
    ...
    vicheda      : [
      ...
      'अधः च मूलानि अनु-सन्ततानि कर्म-अनुबन्धीनि मनुष्य-लोके ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Cha: And',
      'Urdhvam: Above',
      'Prasritah: Extended / Spread out',
      'Tasya: Its (the tree\'s)',
      'Shakhah: Branches',
      'Guna-pravriddhah: Nourished / Enlarged by the Gunas',
      'Vishaya-pravalah: Sense objects as shoots / buds',
      'Mulani: Roots (secondary roots/aerial roots)',
      'Anu-santatani: Stretched / Bound across',
    ...
    notes     : [
      ...
      'Urdhva/Adhah: Branches "above" refer to higher realms (Devas), while "below" refers to lower animal or hellish realms. Humans are in the middle where the secondary roots bind most strongly.',
    ],
  },
  {
    chapter      : 15,
    ...
    sloka_tel    : [
      ...
      'అశ్వత్థమేనం సువిరూఢమూలమసఙ్గశస్త్రేణ దృఢేన ఛిత్త్వా ||',
    ],
    vicheda      : [
      'न रूपम् अस्य इह तथा उपलभ्यते न अन्तः न च आदिः न च सम्प्रतिष्ठा |',
      'अश्वत्थम् एनम् सु-विरूढ-मूलम् असङ्ग-शस्त्रेण दृढेन छित्त्वा ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Tatha: In that way / as it is',
      'Upalabhyate: Is perceived / Is known',
      'Antah: End',
      'Adih: Beginning',
      'Sampratishtha: Foundation / Base',
      'Ashvattham: The Ashvattha tree',
      'Enam: This',
      'Su-virudha-mulam: Having very deeply/strongly fixed roots',
      'Asanga-shastrena: With the weapon of detachment/non-attachment',
    ...
    notes        : [
      ...
      'The Paradox of "Avyayam": In 15.1, the tree was called eternal (Avyayam), but here Krishna says it must be cut. This means that while the cycle of the world is eternal for the ignorant, it can be terminated for the individual who attains knowledge.',
    ],
  },
  {
    chapter      : 15,
    ...
    vicheda      : [
      ...
      'तम् एव च आद्यम् पुरुषम् प्रपद्ये यतः प्रवृत्तिः प्रसृता पुराणी ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Tat: That',
      'Parimargitavyam: Must be sought / Must be searched for',
      'Yasmin: In which',
      'Gatah: Having gone',
      'Na: Not',
      'Nivartanti: Return / Come back',
      'Bhuyah: Again',
      'Tam: To Him',
      'Eva: Alone / Indeed',
      'Adyam: Primeval / Original',
      'Purusham: The Person / Being',
      'Prapadye: I take refuge / I surrender',
      'Yatah: From whom',
      'Pravrittih: Manifestation / Stream of activity',
    ...
    notes        : [
      ...
      'The "Search" (Parimārg): This isn\'t a physical search but a deep meditative inquiry into the nature of the "Self" that stands behind the ego.',
    ],
  },
  {
    chapter      : 15,
    ...
    sloka        : [
      ...
      'द्वन्द्वैर्विमुक्ताः सुखदुःखसंज्ञैर्गच्छन्त्यमूढाः पदमव्ययम् तत् ||',
    ],
    sloka_tel    : [
      'నిర్మానమోహా జితసంగదోషా అధ్యాత్మనిత్యా వినివృత్తకామాః |',
      'ద్వంద్వైర్విముక్తాః సుఖదుఃఖసంజ్ఞైర్గచ్ఛన్త్యమూఢాః పదమవ్యయమ్ తత్ ||',
    ],
    vicheda      : [
      'निः-मान-मोहाः जित-सङ्ग-दोषाः अध्यात्म-नित्याः वि-निवृत्त-कामाः |',
      'द्वन्द्वैः वि-मुक्ताः सुख-दुःख-संज्ञैः गच्छन्ति अमूढाः पदम् अव्ययम् तत् ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Vinivritta-kamah: Those whose desires have ceased',
      'Dvandvaih: From dualities',
      'Vimuktah: Liberated / Free',
      'Sukha-duhkha-samjnaih: Known as pleasure and pain',
      'Gacchanti: They go / attain',
      'Amudhah: The undeluded / wise',
      'Padam: Goal / State',
      'Avyayam: Eternal / Imperishable',
      'Tat: That',
    ],
    notes        : [
      ...
      'Adhyātmanityāḥ: This is the positive anchor. While "cutting" the negative, one must stay "constantly" (Nitya) absorbed in the study and contemplation of the Self.',
      'Dvandvair-vimuktāḥ: The world is a series of pairs (hot/cold, win/loss). The undeluded person remains the same in both, like a rock in the middle of waves.',
    ],
  },
  {
    chapter      : 15,
    ...
    vicheda      : [
      ...
      'यद् गत्वा न निवर्तन्ते तत् धाम परमम् मम ||',
      ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Pavakah: Fire',
      'Yad: Which',
      'Gatva: Having gone / Having reached',
      'Nivartante: Return',
      'Dhama: Abode / State / Radiance',
      'Paramam: Supreme',
      'Mama: My',
    ],
    notes        : [
      ...
      'Yad gatvā na nivartante: This reinforces the promise from 15.4. It is a permanent shift in consciousness. Once you wake up from a dream, you cannot "return" to being the character in that dream with the same ignorance.',
    ],
  },
  {
    chapter      : 15,
    ...
    meanings     : [
      ...
      'Jiva-loke: In the world of living beings',
      'Jiva-bhutah: Becoming a living soul',
      'Sanatanah: Eternal',
      'Manah-shashthani: With the mind as the sixth',
    ...
    notes        : [
      ...
      'Manaḥ-ṣaṣṭhāni: The mind is counted as the "sixth sense" because it coordinates the input of the other five (seeing, hearing, smelling, tasting, touching).',
      'Sanātanah: This reminds us that our true identity is eternal. We were never "born" into the tree; we have simply become identified with the branches.',
    ],
  },
  {
    chapter      : 15,
    ...
    vicheda      : [
      ...
      'गृहीत्वा एतानि सम्-याति वायुः गन्धान् इव आशयात् ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Yat: Which',
      'Cha api: And also',
      'Utkramati: Leaves / Departs',
      'Ishvarah: The Lord (here, the master of the body/Jiva)',
      'Grihitva: Having taken / Having seized',
      'Etani: These (the senses and mind)',
      'Samyati: Goes away / Travels',
      'Vayuh: The Wind',
      'Gandhan: Scents / Fragrances',
      'Iva: Like / As',
    ...
    notes        : [
      ...
      'Etāni gṛhītvā: "Taking these." This explains why we have certain natural inclinations or talents from birth—they are the "scents" gathered from a previous "flower" (body).',
    ],
  },
  {
    chapter      : 15,
    ...
    meanings     : [
      ...
      'Ghranam: The nose / sense of smell',
      'Eva: Indeed',
      'Cha: And',
      'Adhisthaya: Presiding over / Residing in',
      'Manah: The mind',
      'Ayam: This (the soul)',
    ...
    notes        : [
      ...
      'The Mind as the Hub: Even with five senses, the mind must be involved. If the mind is elsewhere, the eyes may be open, but we do not "see." This is why Krishna specifically mentions "Manas-ca" (and the mind) alongside the five senses.',
    ],
  },
  {
    chapter      : 15,
    ...
    vicheda      : [
      ...
      'विमूढाः न अनु-पश्यन्ति पश्यन्ति ज्ञान-चक्षुषः ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Va api: Or even',
      'Bhunjanam: Enjoying / Experiencing',
      'Va: Or',
      'Guna-anvitam: Associated with the Gunas (modes of nature)',
      'Vimudhah: The deluded / The foolish',
      'Na: Not',
      'Anupashyanti: Do not see / Do not perceive',
      'Pashyanti: They see',
    ...
    notes        : [
      ...
      'Jnana-chakshushah: This "eye of knowledge" is not a physical third eye, but the faculty of discrimination (Viveka). It is the ability to separate the "Seen" from the "Seer."',
    ],
  },
  {
    chapter      : 15,
    ...
    sloka_tel    : [
      ...
      'యతంతోఽప్యకృతాత్మానో నైనం పశ్యన్త్యచేతసః ||',
    ],
    vicheda      : [
      'यतन्तः योगिनः च एनम् पश्यन्ति आत्मनि अवस्थितम् |',
      'यतन्तः अपि अ-कृत-आत्मानः न एनम् पश्यन्ति अ-चेतसः ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Cha: And',
      'Enam: This (the soul)',
      'Pashyanti: They see / perceive',
      'Atmani: In the self / in the heart',
      'Avasthitam: Dwelling / Situated',
      'Api: Even though / also',
      'A-krita-atmanah: Those of unrefined mind / unpurified self',
      'Na: Not',
    ...
    notes        : [
      ...
      'A-cetasaḥ: "Mindless" or "unconscious." It implies a lack of Viveka (discrimination). Even if the soul is pointed out to them, they cannot recognize it because their focus is entirely external.',
      'Atmāni Avasthitam: The soul isn\'t far away in a distant heaven; it is "seated within." The discovery is an internal realization, not an external journey.',
    ],
  },
  {
    chapter      : 15,
    ...
    notes        : [
      ...
      'Viddhi Māmakam: "Know it to be Mine." This is an exercise in "Vibhuti Yoga"—practicing the vision of seeing God in everyday wonders. When you see the sunrise, Krishna asks you to recognize His brilliance in it.',
    ],
  },
  {
    chapter      : 15,
    ...
    vicheda      : [
      ...
      'पुष्णामि च ओषधीः सर्वाः सोमः भूत्वा रस-आत्मकः ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Avishya: Entering',
      'Bhutani: Beings',
      'Dharayami: I support / sustain',
      'Aham: I',
      'Ojasa: By vital energy / strength',
      'Pushnami: I nourish',
      'Oshadhih: Plants / Herbs',
      'Sarvah: All',
      'Somah: The Moon',
  ...
  },
  {
    ...
    vicheda      : [
      ...
      'प्राण-अपान-समायुक्तः पचामि अन्नम् चतुर्-विधम् ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Deham: The body',
      'Ashritah: Residing in',
      'Prana-apana: The incoming and outgoing breaths',
      'Samayuktah: United with',
      'Pachami: I digest / cook',
      'Annam: Food',
  ...
  },
  {
    ...
    vicheda      : [
      'सर्वस्य च अहम् हृदि सन्-निविष्टः मत्तः स्मृतिः ज्ञानम् अपोहनम् च |',
      'वेदैः च सर्वैः अहम् एव वेद्यः वेदान्त-कृत् वेद-वित् एव च अहम् ||',
    ],
    anvaya       : [
  ...
  },
  {
    ...
    vicheda      : [
      ...
      'क्षरः सर्वाणि भूतानि कूट-स्थः अक्षरः उच्यते ||',
    ],
    anvaya       : [
    ...
    meanings     : [
      ...
      'Ksharah: Perishable / Changeable',
      'Aksharah: Imperishable / Unchanging',
      'Sarvani Bhutani: All living beings / elements',
  ...
  },
  {
    ...
    vicheda      : [
      ...
      'यः लोक-त्रयम् आविश्य बिभर्ति अव्ययः ईश्वरः ||',
    ],
    anvaya       : [
  ...
  },
  {
    ...
    vicheda      : [
      'यस्मात् क्षरम् अतीतः अहम् अक्षरात अपि च उत्तमः |',
  ...
  },
  {
    ...
    vicheda      : [
      'यः माम् एवम् अ-संमूढः जानाति पुरुष-उत्तमम् |',
  ...
  },
  {
    ...
    sloka_tel    : [
      'ఇతి గుహ్యతమం శాస్త్రమిదముక్తం మయాఽనఘ |',
      'ఏతద్బుద్ధ్వా బుద్ధిమాన్ స్యాత్ కృతకృత్యశ్చ భారత ||',
    ],
    vicheda      : [
      'इति गुह्य-तमम् शास्त्रम् इदम् उक्तम् मया अनघ |',
      'एतत् बुद्ध्वा बुद्धिमान् स्यात् कृत-कृत्यः च भारत ||',
    ],
    anvaya       : [
